...
% R2* correction.
%
% ***** MULTI COIL (Coil combine first before fw decomposition) *****
%
...
%% *************************************************************************
% ---> CODE UTILIZES DIEGO HERNANDO's coilCombine FUNCTION TO COMBINE MULTI
% COIL DATA INTO A SINGLE VIRTUAL COIL BEFORE FW DECOMPOSITION <--- 
% 
% by H. Harry Hu (houchunh@usc.edu)
% last modified, December 21, 2011 for Diego Hernando's Matlab Toolbox
%% *************************************************************************
