...
ct.SetOrigin((0, 0, 0))
chi = sitk.ReadImage('../../../../data/reconstructed/subjectCT16/20170216_113523_0302_chi_MEDIl2TVcg_LBV_unwrap_CSS.nii.gz')
chi.SetOrigin((0, 0, 0))
...
ct.SetOrigin((0, 0, 0))
chi = sitk.ReadImage('../../../../data/reconstructed/subjectCT17/20170407_115911_0302_chi_MEDIl2TVcg_LBV_unwrap_CSS.nii.gz')
chi.SetOrigin((0, 0, 0))
...
df.to_csv('figure_MEDIl2.dat', index=False)
print(df)
